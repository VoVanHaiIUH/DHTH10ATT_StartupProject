...
namespace PresentationTier.CongNo
{
    public partial class frmTraNoNCC : Form
    {
        ...
        {
            List<eCongNoNCC> l = CN.GetListNoCuaNhaCungCap(pMaNCC);
            pRoot.Nodes.Clear();
            // tổng sô nợ
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            try
            {
                if (CN.TraNoNCC(tbxMaHoaDon.Text, NhanVien.MaNhanVien, decimal.Parse(tbxSoTien.Text), ricGhiChu.Text) != null)
                {
                    LoadTrv();
                ...
                MessageBox.Show("Trả nợ không thành công");
