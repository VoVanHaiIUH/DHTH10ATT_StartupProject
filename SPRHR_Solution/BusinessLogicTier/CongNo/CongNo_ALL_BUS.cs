...
namespace BusinessLogicTier.CongNo
{
    public class CongNo_ALL_BUS
    {
        ...
        {
            return CongNoDAL.GetListNoCuaNhaCungCap(pMaNhaCungCap);
        }
        public List<eCongNoKhachHang> GetListNoCuaKhachHang(string pMaKhachHang)
        {
            return CongNoDAL.GetListNoCuaKhachHang(pMaKhachHang);
        }
